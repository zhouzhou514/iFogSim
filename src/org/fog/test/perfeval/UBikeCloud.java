...
public class UBikeCloud {
    ...
    public static void main(String[] args) {
        ...
        Log.printLine("Starting UBikeCloud...");
        ...
        try {
            ...
            String appId = "ubikecloud"; // identifier of the application
...
*/				moduleMapping.addModuleToDevice("cloud_scheduler", "cloud"); // fixing all instances of the cloud prediction module to the Cloud
    ...
    private static Application createApplication(String appId, int userId){
         ...
         */
        final AppLoop loop1 = new AppLoop(new ArrayList<String>(){{add("BIKE_USEAGE");add("bikedata_collector");add("cloud_scheduler");add("worker_reminder");add("REMINDER_MSG");}});
